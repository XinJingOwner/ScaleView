...
public class ScaleCalculator {
     ...
     */
    private static float BASE_SCREEN_WIDTH = 1920.0f;
    private static float BASE_SCREEN_HEIGHT = 1080.0f;
    private static float BASE_SCREEN_DENSITY = 1.5f;
    ...
    public final void setBaseDensity(float baseDensity) {
    	if (baseDensity > 0) {
    		BASE_SCREEN_DENSITY = baseDensity;
    	}
    }
    ...
    private final int getBaseSize(float pixel) {
        return (int) (0.5F + pixel / ScaleCalculator.mCurScreenDensity
    ...
    private final boolean isBaseHeight() {
        return (ScaleCalculator.mCurScreenHeight
                / ScaleCalculator.BASE_SCREEN_HEIGHT == ScaleCalculator.mCurScreenDensity
                / ScaleCalculator.BASE_SCREEN_DENSITY);
    }

    private final boolean isBaseWidth() {
        return (ScaleCalculator.mCurScreenWidth
                / ScaleCalculator.BASE_SCREEN_WIDTH == ScaleCalculator.mCurScreenDensity
                / ScaleCalculator.BASE_SCREEN_DENSITY);
    }
